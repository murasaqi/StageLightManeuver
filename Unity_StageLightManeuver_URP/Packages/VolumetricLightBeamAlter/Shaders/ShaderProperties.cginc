...
VLB_DEFINE_PROP_START
    ...
    // VLB_DEFINE_PROP(Texture2D, _GoboTexture)
    ...
    VLB_DEFINE_PROP(float3, _DynamicOcclusionDepthProps) // x = should flip x? ; y = should flip y? ; z = fade distance
    // endif
...
#endif
uniform sampler2D _GoboTexture;
/// ****************************************
